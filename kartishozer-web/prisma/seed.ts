...
async function main() {
  ...
  const events: {
    ...
    { id: "e6", nameHe: "\"הקוסם הקטן\" — הצגת ילדים מוזיקלית", category: "attractions", venueId: "v4", startsAt: inDays(11, 11, 0), descriptionHe: "הצגה מוזיקלית צבעונית לכל המשפחה, מומלץ מגיל 3.", gradientFrom: "#EF9F27", gradientTo: "#FFC96B", emoji: "🎪" },
    ...
    { id: "e11", nameHe: "\"עולם הבועות\" — מופע ילדים אינטראקטיבי", category: "attractions", venueId: "v1", startsAt: inDays(16, 10, 30), descriptionHe: "מופע בועות ענק עם קסמים ואפקטים, מתאים לכל המשפחה.", gradientFrom: "#EF9F27", gradientTo: "#FFC96B", emoji: "🫧" },
